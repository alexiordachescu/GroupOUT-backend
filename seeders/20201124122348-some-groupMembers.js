...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert("groupMembers", [
      ...
      { groupId: 2, userId: 6, createdAt: new Date(), updatedAt: new Date() },
      { groupId: 3, userId: 7, createdAt: new Date(), updatedAt: new Date() },
      { groupId: 3, userId: 3, createdAt: new Date(), updatedAt: new Date() },
      { groupId: 3, userId: 2, createdAt: new Date(), updatedAt: new Date() },
